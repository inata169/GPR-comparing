...
> **Archive notice:** This file preserves the former Japanese canonical README as it existed before the English documentation reorganization. The current public canonical document is [`README.md`](README.md). Historical references to earlier project names and validation language are retained here as archival context and must not be interpreted as current claims.
