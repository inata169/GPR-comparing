...
def build_provenance(
    *,
    ...
    requested_opt_shift: bool,
    identity_comparison_shortcut: bool,
    engine_version: str,
    mode: str,
    plane: str | None,
    ...
    return {
        ...
        'analysis': {
            ...
            'opt_shift_requested': bool(requested_opt_shift),
            'identity_comparison_shortcut': bool(identity_comparison_shortcut),
