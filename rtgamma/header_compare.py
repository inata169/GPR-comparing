...
def run_header_comparison(path_a, path_b, report_path, plan_a_path=None, plan_b_path=None):
    meta_a = load_rtdose(path_a)
    meta_b = load_rtdose(path_b)
    ...
    plan_a = load_rtplan(plan_a_path) if plan_a_path else None
    plan_b = load_rtplan(plan_b_path) if plan_b_path else None
